...
def register():
    ...
    if form.validate_on_submit():
        ...
        #   - message
        #   - category(for css styling purpose): success, error, warning etc.
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user and bcrypt.check_password_hash(user.password, form.password.data):
            ...
            # if 'next' query is generated by user (eg. in case of accessing
            # accounts page when logged out), check it in flask.request
            # arguments if it exist, redirect the user to the requested
...
@app.route("/logout")
def logout():
    # To logout any logged in user just run this func:
    logout_user()
